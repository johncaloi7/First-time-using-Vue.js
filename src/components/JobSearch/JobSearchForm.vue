<template>
  ...
  >
    ...
    <section class="flex h-full flex-1 flex-nowrap text-base font-light">
      <article class="relative flex h-full flex-1 items-center pr-3">
      ...
      <span
        ...
        >in</span
      >
      <article class="relative flex h-full flex-1 items-center pl-3">
